    ...
    def __init__(self, raw_results=None):
        ...
        if raw_results is not None:
            (self.recommendation_order, self.recommended_res, self.max_seq_res, self.weighted_surface_value, self.weighted_mainchain_surface_value,
             ...
             self.homo_dist_conf, self.location_conf, self.classification_conf, self.amount_of_structures, self.rsa_change_score, self.mc_rsa_change_score, self.sc_rsa_change_score) = raw_results
